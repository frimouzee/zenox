            ...
            if isinstance(channel, discord.TextChannel):
                ...
                if self.cog.bot.user:
                    try:
                        ...
                        icon_url = None
                embed.set_footer(text="ZenoX - Ticketing", icon_url=icon_url)
...
class TicketCog(commands.Cog):
    ...
    def build_panel_embed(self, config: PanelConfig) -> discord.Embed:
        ...
        if config.embed_footer:
            ...
            embed.set_footer(text="ZenoX - Ticketing", icon_url=footer_icon)
        return embed
                ...
                if user:
                    ...
                    if self.bot.user:
                        try:
                            ...
                            icon_url_dm = None
                    dm_embed.set_footer(text="ZenoX - Ticketing", icon_url=icon_url_dm)
    ...
    async def ticket_sendpanel(self, ctx: commands.Context, panel: str) -> None:
        ...
        if self.bot.user:
            try:
                ...
                icon_url = None
        confirmation.set_footer(text="ZenoX - Ticketing", icon_url=icon_url)
