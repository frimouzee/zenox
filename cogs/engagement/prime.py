    ...
    async def predicate(ctx):
        ...
        if not row:
            embed = discord.Embed(
                ...
                description=f"{E_EXCL} This command requires **Premium** to execute.\nYou can buy premium by clicking **[here](https://discord.gg/PkskjbxwBj)**.",
                color=0x2b2d31
            )
...
class Premium(commands.Cog):
    ...
    async def generate(self, ctx, uses: int, duration: str):
        ...
        code = f"ZENOX-PREMIUM-{random_part}"
        ...
        embed.set_footer(text="ZenoX Premium System", icon_url=self.bot.user.display_avatar.url)
    ...
    async def activate(self, ctx, code: str):
        ...
        try:
            await ctx.guild.me.edit(nick="ZenoX Prime")
        except:
            pass
    ...
    async def deactivate(self, ctx):
        ...
        try:
            await ctx.guild.me.edit(nick="ZenoX", avatar=None, banner=None, bio=None)
        except:
            pass
    ...
    async def revoke(self, ctx, guild_id: int):
        ...
        if guild:
            try:
                await guild.me.edit(nick="ZenoX", avatar=None, banner=None, bio=None)
            except:
                pass
