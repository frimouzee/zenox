...
class General(commands.Cog):
  ...
  @commands.command(name="users", help="checks total users of ZenoX.")
  @blacklist_check()
  @ignore_check()
  @commands.cooldown(1, 3, commands.BucketType.user)
  ...
  async def invite(self, ctx: commands.Context):
    embed = discord.Embed(
        title="ZenoX Invite & Support",
        description=(
            "- Hello! I'm **ZenoX**, your comprehensive server security solution with advanced protection features.\n\n"
            "- Need help or want to add me to your server? Use the buttons below!"
        ),
        color=0x2b2d31
    )
    embed.set_footer(text="ZenoX — The Ultimate Security Solution")

    view = discord.ui.View()
    view.add_item(discord.ui.Button(
        label='Add ZenoX',
        style=discord.ButtonStyle.link,
        url='https://discord.com/oauth2/authorize?client_id=1462047381100036126&permissions=4584022855830758&integration_type=0&scope=bot'
    ))
    view.add_item(discord.ui.Button(
        label='Support Server',
        style=discord.ButtonStyle.link,
        url='https://discord.gg/PkskjbxwBj'
    ))
