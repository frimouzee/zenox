                ...
                if channel and guild_id:
                    embed = discord.Embed(
                        description=(
                            ...
                            f"If you believe this is a mistake, please contact our [Support Server](https://discord.gg/PkskjbxwBj)."
                        ),
                        color=0x000000
                    )
        ...
        if retry:
            async with aiosqlite.connect(self.db_path) as db:
                ...
                if message.content in (f'<@{self.bot_user_id}>', f'<@!{self.bot_user_id}>'):
                    ...
                    embed = discord.Embed(
                        description=f"**{message.author.mention} has been blacklisted for repeatedly mentioning me. If you believe this is a mistake, please contact our [Support Server](https://discord.gg/PkskjbxwBj) with any proof if possible.**",
                        color=0x000000
                    )
                    await message.channel.send(embed=embed)
                    return
        ...
        if retry:
            async with aiosqlite.connect(self.db_path) as db:
                ...
                embed = discord.Embed(
                    ...
                    description=f"**{ctx.author.mention} has been blacklisted for spamming commands. If you believe this is a mistake, please contact our [Support Server](https://discord.gg/PkskjbxwBj) with any proof if possible.**",
                    color=0x000000
                )
