...
class VoiceMaster(commands.Cog):
    ...
    async def vm_setup(self, ctx: commands.Context):
        ...
        try:
            category = await guild.create_category("ZenoX Voice", reason="VoiceMaster setup")
            ...
            embed.set_author(name="ZenoX Interface", icon_url=bot_avatar)
            ...
            embed.set_footer(text="ZenoX — VoiceMaster Control Center", icon_url=bot_avatar)
    ...
    async def vm_config(self, ctx: commands.Context):
        ...
        embed.set_footer(text="ZenoX - VoiceMaster")
